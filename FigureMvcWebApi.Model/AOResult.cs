...
namespace FigureMvcWebApi.Model
{
    ...
    public class AOResult<T>
    {
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:FigureMvcWebApi.Model.Outputs.AOResult`1"/> is success.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:FigureMvcWebApi.Model.Outputs.AOResult`1"/> tracking result.
        /// </summary>
